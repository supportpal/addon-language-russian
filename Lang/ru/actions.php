...
return array(
    ...
    "email_operator_group"      => "Отправить письмо в группу операторов",
    "email_user"                => "Отправить письмо пользователю",
    "email_user_group"          => "Отправка письмо в группу пользователей",
    ...
    "hours_to_be_removed"       => "Часы, которые будут удалены из текущего срока.",
    ...
    "watch_ticket"              => "Добавить оператора в отслеживаемые",
    "unwatch_ticket"            => "Удалить оператора из отслеживаемых",
